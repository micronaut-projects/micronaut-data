...
/**
 * This tests operations with an entity that does not have partition key defined using reactive operations.
 */
@IgnoreIf({ env["GITHUB_WORKFLOW"] })
class NoPartitionKeyCosmosReactiveDbSpec extends Specification implements CosmosReactiveConfigured {
