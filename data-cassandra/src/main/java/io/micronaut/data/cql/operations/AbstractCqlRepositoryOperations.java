...
import io.micronaut.data.model.query.builder.cql.CqlQueryBuilder;
...
public abstract class AbstractCqlRepositoryOperations<RS,PS> implements RepositoryOperations {
     ...
     */
    protected AbstractCqlRepositoryOperations(
...
//            final SqlQueryBuilder queryBuilder = queryBuilders.getOrDefault(dialect, DEFAULT_SQL_BUILDER);
            final QueryResult queryResult = this.queryBuilder.buildInsert(annotationMetadata, persistentEntity);
    ...
    <T> StoredInsert<T> resolveEntityUpdate(
        ...
        return entityUpdates.computeIfAbsent(key, (queryKey) -> {
            ...
            final QueryResult queryResult = this.queryBuilder.buildUpdate(
                annotationMetadata,
                queryModel,
                updateProperties
            );
    ...
    protected <T> String resolveAssociationInsert(
        ...
        return associationInserts.computeIfAbsent(association, association1 -> {
            ...
            return this.queryBuilder.buildJoinTableInsert(persistentEntity, association1);
        });
    }
