 ...
 * @since 4.0.0
 */
public class MappedEmbeddedIdMapper implements TypedAnnotationMapper<EmbeddedId> {
    ...
    @Override
    public List<AnnotationValue<?>> map(AnnotationValue<EmbeddedId> annotation, VisitorContext visitorContext) {
