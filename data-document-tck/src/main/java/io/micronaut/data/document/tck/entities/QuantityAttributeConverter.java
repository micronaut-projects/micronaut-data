...
public class QuantityAttributeConverter implements AttributeConverter<Quantity, Integer> {
    ...
    @Override
    @Nullable
    public Integer convertToPersistedValue(@Nullable Quantity quantity, ConversionContext context) {
        return quantity == null ? null : quantity.getAmount();
    }

    @Override
    @Nullable
    public Quantity convertToEntityValue(@Nullable Integer value, ConversionContext context) {
