...
class H2EnumsMappingSpec extends Specification implements H2TestPropertyProvider {
    ...
    void "test create table with enums"() {
        ...
        when:
            def sql = builder.buildBatchCreateTableStatement(null, List.of(), PersistentEntity.of(EnumEntity))
    ...
    void "test jpa create table with enums"() {
        ...
        when:
            def sql = builder.buildBatchCreateTableStatement(null, List.of(), PersistentEntity.of(JpaEnumEntity))
