package io.micronaut.data.jdbc.h2.jakarta_data.entity;

import io.micronaut.context.annotation.Property;
import io.micronaut.data.jdbc.h2.H2DBProperties;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only.AsciiCharacter;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only.AsciiCharacters;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only.AsciiCharactersPopulator;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only.CustomRepository;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only.NaturalNumber;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only.NaturalNumber.NumberType;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only.NaturalNumbers;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only.NaturalNumbersPopulator;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only.PositiveIntegers;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only._AsciiChar;
import io.micronaut.data.jdbc.h2.jakarta_data.read.only._AsciiCharacter;
import io.micronaut.data.jdbc.h2.jakarta_data.utilities.DatabaseType;
import io.micronaut.data.jdbc.h2.jakarta_data.utilities.TestProperty;
...
import static io.micronaut.data.jdbc.h2.jakarta_data.read.only.NaturalNumber.NumberType.*;
