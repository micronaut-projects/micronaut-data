package io.micronaut.data.jdbc.h2.jakarta_data.read.only;
...
public interface NaturalNumbers extends BasicRepository<NaturalNumber, Long>, IdOperations {
    ...
    @Query("WHERE isOdd = false AND numType = io.micronaut.data.jdbc.h2.jakarta_data.read.only.NaturalNumber.NumberType.PRIME")
