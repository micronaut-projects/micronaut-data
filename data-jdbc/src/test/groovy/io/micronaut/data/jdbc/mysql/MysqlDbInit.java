...
@Context
@Singleton
public class MysqlDbInit implements BeanCreatedEventListener<BasicJdbcConfiguration> {
    ...
    public BasicJdbcConfiguration onCreated(BeanCreatedEvent<BasicJdbcConfiguration> event) {
        ...
        if (!configuration.getConfiguredDriverClassName().toLowerCase(Locale.ROOT).contains("mysql")) {
