...
interface PostgresBatchInsertBookRepository extends CrudRepository<PostgresBatchInsertBook, Long> {

    @Insert
    void customInsertAll(List<PostgresBatchInsertBook> entities)

    @Insert
    long customInsertAllCount(List<PostgresBatchInsertBook> entities)
}
