...
CREATE TABLE "TBL_STUDENT" ("ID" NUMBER(19) GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL PRIMARY KEY,"NAME" VARCHAR(255) NOT NULL, AVERAGE_GRADE BINARY_DOUBLE, START_DATE_TIME TIMESTAMP(6), ACTIVE NUMBER(1) DEFAULT 1);
