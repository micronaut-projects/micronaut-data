...
/**
 * Interceptor for {@code jakarta.data.repository.stateful.Refresh} methods.
 *
 ...
 */
@Internal
public final class RefreshInterceptor<T> extends AbstractQueryInterceptor<T, Void> implements DataInterceptor<T, Void> {

    private final JpaRepositoryOperations jpaRepositoryOperations;

    RefreshInterceptor(@NonNull RepositoryOperations operations) {
        super(operations);
    ...
    private void refreshValue(Object value) {
        ...
        jpaRepositoryOperations.refresh(value);
    }
}
