...
/**
 * Interceptor for {@link jakarta.data.repository.stateful.Remove} methods.
 *
 ...
 */
@Internal
public final class RemoveInterceptor<T> extends AbstractQueryInterceptor<T, Void> implements DataInterceptor<T, Void> {

    private final JpaRepositoryOperations jpaRepositoryOperations;

    RemoveInterceptor(@NonNull RepositoryOperations operations) {
        super(operations);
    ...
    private void removeValue(Object value) {
        ...
        jpaRepositoryOperations.remove(value);
    }
}
