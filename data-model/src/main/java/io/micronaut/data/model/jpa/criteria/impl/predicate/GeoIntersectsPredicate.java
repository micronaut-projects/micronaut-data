...
/**
 * MongoDB geospatial predicate for {@code $geoIntersects} queries.
 *
 * @since 5.0.0
 */
@Internal
public final class GeoIntersectsPredicate extends AbstractPredicate {

    private final Expression<?> expression;
    private final Expression<?> geometry;

    public GeoIntersectsPredicate(Expression<?> expression, Expression<?> geometry) {
