    ...
    static Column getColumn(PersistentProperty prop, String column, boolean primaryKey, boolean required, boolean isForeign) {
        ...
        switch (dataType) {
            case STRING:
                ...
                return new Column(column, dataType, dbType, primaryKey, length, required, autoGenerated, generatedValueType, definition);
            case UUID:
            case BOOLEAN:
            case TIMESTAMP:
            case DATE:
            ...
            case JSON:
                ...
                return new Column(column, dataType, dbType, primaryKey, length, precision, scale, required, autoGenerated, generatedValueType,
            ...
            case INTEGER:
                ...
                return new Column(column, dataType, dbType, primaryKey, length, precision, required, autoGenerated, generatedValueType,
                    definition);
            case BIGDECIMAL:
            case FLOAT:
            case DOUBLE:
