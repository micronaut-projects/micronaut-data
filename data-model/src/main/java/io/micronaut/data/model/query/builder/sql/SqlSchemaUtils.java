...
public final class SqlSchemaUtils {
    ...
    private static SqlColumnMapping getColumnDefinition(PersistentProperty prop, String column, boolean primaryKey, boolean required,
        ...
        return switch (dataType) {
            ...
            case VECTOR ,VECTOR_FLOAT, VECTOR_BYTE, VECTOR_INT, VECTOR_DOUBLE -> new SqlColumnMapping(column, dataType, dbType, primaryKey, null, null, null, required, autoGenerated, generatedValueType, definition, null);
            default -> {
    ...
    private static SqlDbType getDbType(PersistentProperty property) {
        ...
        return switch (dataType) {
            ...
            case VECTOR, VECTOR_FLOAT, VECTOR_BYTE, VECTOR_INT, VECTOR_DOUBLE -> SqlDbType.VECTOR;
