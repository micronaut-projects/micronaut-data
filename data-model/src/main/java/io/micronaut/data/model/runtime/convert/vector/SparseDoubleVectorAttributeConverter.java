 ...
 *
 * @param <X> The persisted value type
 * @author Nemanja Mikic
 * @since 5.0.0
 */
@Indexed(SparseDoubleVectorAttributeConverter.class)
public interface SparseDoubleVectorAttributeConverter<X> extends AttributeConverter<SparseDoubleVector, X>, SqlColumnDefinitionProvider {
}
