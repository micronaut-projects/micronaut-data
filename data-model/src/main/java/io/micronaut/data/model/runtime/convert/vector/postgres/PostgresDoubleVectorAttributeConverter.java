...
public final class PostgresDoubleVectorAttributeConverter implements DoubleVectorAttributeConverter<PGobject> {

    @Override
    public @Nullable PGobject convertToPersistedValue(@Nullable Vector.DoubleVector entityValue, @NonNull ConversionContext context) {
        if (entityValue == null) {
            return null;
        }
    ...
    @Override
    public @Nullable Vector.DoubleVector convertToEntityValue(@Nullable PGobject persistedValue, @NonNull ConversionContext context) {
