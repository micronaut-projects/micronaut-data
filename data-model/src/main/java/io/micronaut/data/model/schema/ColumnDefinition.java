...
public final class ColumnDefinition {
     ...
     */
    public ColumnDefinition(String name, DataType dataType, DbType dbType, boolean primaryKey, Integer length, Integer precision, Integer scale,
     ...
     * @param definition        the definition of the column (optional)
     */
    public ColumnDefinition(String name, DataType dataType, DbType dbType, boolean primaryKey, @Nullable Integer length, boolean required,
     ...
     * @param definition        the definition of the column (optional)
     */
    public ColumnDefinition(String name, DataType dataType, DbType dbType, boolean primaryKey, @Nullable Integer length,
    ...
    public String getSqlType(Dialect dialect) {
        ...
        switch (dataType) {
            ...
            case BOOLEAN_ARRAY:
                ...
                break;
            default:
                if (dbType == DbType.ENUM) {
                    // Special case for enum
                    typeDef = "VARCHAR(255)";
                } else if (dbType == DbType.CLOB) {
                    if (dialect == Dialect.POSTGRES) {
                        typeDef = "TEXT";
                    } else {
                        typeDef = "CLOB";
