...
public final class SqlColumnMapping {
    ...
    public SqlColumnMapping(String name, DataType dataType, SqlDbType dbType) {
        this(name, dataType, dbType, null, null, null, false, false, GeneratedValue.Type.AUTO, null, null, ReservableOptions.NONE);
    }
    ...
    public SqlColumnMapping(String name, DataType dataType, SqlDbType dbType, @Nullable Integer length, @Nullable Integer precision, @Nullable Integer scale,
        ...
        this(name, dataType, dbType, length, precision, scale, required, autoGenerated, generatedValueType, definition, jsonDataType, ReservableOptions.NONE);
    }
     ...
     * @param definition         the definition of the column (optional)
     * @param jsonDataType       the JSON data type (optional)
     * @param reservableOptions  Oracle reservable column options
     */
    @SuppressWarnings("java:S107")
    public SqlColumnMapping(String name, DataType dataType, SqlDbType dbType, @Nullable Integer length, @Nullable Integer precision, @Nullable Integer scale,
                            boolean required, boolean autoGenerated, GeneratedValue.Type generatedValueType, @Nullable String definition, @Nullable JsonDataType jsonDataType,
                            ReservableOptions reservableOptions) {
        this.name = name;
        ...
        this.reservable = reservableOptions.reservable;
        this.checkConstraints = List.copyOf(reservableOptions.checkConstraints);
    }
    ...
    /**
     * @return whether this column is an Oracle reservable column
     */
    ...
    /**
     * @return generated check constraints for this column
     */
    ...
    /**
     * SQL check constraint metadata.
     *
     * @param name The constraint name
     * @param operator The comparison operator
     * @param value The comparison value
     */
    public record SqlCheckConstraint(String name, String operator, String value) {
    }

    /**
     * Oracle reservable column options.
     *
     * @param reservable whether the column is an Oracle reservable column
     * @param checkConstraints generated check constraints
     */
    public record ReservableOptions(boolean reservable, List<SqlCheckConstraint> checkConstraints) {

        /**
         * Default non-reservable column options.
         */
        public static final ReservableOptions NONE = new ReservableOptions(false, List.of());
    }
}
