package io.micronaut.data.document.mongodb.compound.collectionpath
...
class MongoCompoundCollectionFieldIndexCreationSpec extends Specification implements MongoTestPropertyProvider {
    ...
    List<String> getPackageNames() {
        ['io.micronaut.data.document.mongodb.compound.collectionpath']
    }
...
@MongoRepository
interface CompoundCollectionFieldIndexedEntityRepository extends CrudRepository<CompoundCollectionFieldIndexedEntity, String> {
}
