package io.micronaut.data.document.mongodb.compound.dotpath
...
class MongoCompoundEmbeddedPathIndexCreationSpec extends Specification implements MongoTestPropertyProvider {
    ...
    List<String> getPackageNames() {
        ['io.micronaut.data.document.mongodb.compound.dotpath']
    }
...
@MongoRepository
interface CompoundEmbeddedPathIndexedEntityRepository extends CrudRepository<CompoundEmbeddedPathIndexedEntity, String> {
}
