package io.micronaut.data.document.mongodb.hashed
...
class MongoHashedIndexCreationSpec extends Specification implements MongoTestPropertyProvider {
    ...
    List<String> getPackageNames() {
        ['io.micronaut.data.document.mongodb.hashed']
    }
...
@MongoRepository
interface HashedIndexedEntityRepository extends CrudRepository<HashedIndexedEntity, String> {
}
