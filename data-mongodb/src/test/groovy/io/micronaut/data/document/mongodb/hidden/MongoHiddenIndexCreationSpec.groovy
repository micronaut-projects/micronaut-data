package io.micronaut.data.document.mongodb.hidden
...
class MongoHiddenIndexCreationSpec extends Specification implements MongoTestPropertyProvider {
    ...
    List<String> getPackageNames() {
        ['io.micronaut.data.document.mongodb.hidden']
    }
...
@MongoRepository
interface HiddenIndexedEntityRepository extends CrudRepository<HiddenIndexedEntity, String> {
}
...
@MongoRepository
interface HiddenCompoundIndexedEntityRepository extends CrudRepository<HiddenCompoundIndexedEntity, String> {
}
