package io.micronaut.data.document.mongodb.simple.embedded
...
class MongoEmbeddedFieldIndexCreationSpec extends Specification implements MongoTestPropertyProvider {
    ...
    List<String> getPackageNames() {
        ['io.micronaut.data.document.mongodb.simple.embedded']
    }
...
@MongoRepository
interface EmbeddedFieldIndexedEntityRepository extends CrudRepository<EmbeddedFieldIndexedEntity, String> {
}
