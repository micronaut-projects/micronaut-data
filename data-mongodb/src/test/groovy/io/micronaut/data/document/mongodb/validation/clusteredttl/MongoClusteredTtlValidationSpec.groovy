package isolated.mongodb.validation.clusteredttl
...
class MongoClusteredTtlValidationSpec extends Specification implements MongoTestPropertyProvider {
    ...
    List<String> getPackageNames() {
        ['isolated.mongodb.validation.clusteredttl']
    }
...
@MongoRepository
interface InvalidClusteredTtlEntityRepository extends CrudRepository<InvalidClusteredTtlEntity, String> {
}
