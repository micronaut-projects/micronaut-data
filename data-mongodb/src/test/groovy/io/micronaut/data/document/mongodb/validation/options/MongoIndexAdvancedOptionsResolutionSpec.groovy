...
class CommentSimpleEntity {
    @MongoIndexed(name = 'comment_simple_idx', comment = 'simple-comment')
    String name
}
...
@MongoWildcardIndex(name = 'comment_commit_wildcard_idx', comment = 'wildcard-comment', commitQuorum = 'majority')
