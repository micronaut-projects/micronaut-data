package io.micronaut.data.document.mongodb.validation.reactivewildcardprojection
...
class MongoReactiveWildcardProjectionValidationSpec extends Specification implements MongoSelectReactiveDriver {
    ...
    List<String> getPackageNames() {
        ['io.micronaut.data.document.mongodb.validation.reactivewildcardprojection']
    }
