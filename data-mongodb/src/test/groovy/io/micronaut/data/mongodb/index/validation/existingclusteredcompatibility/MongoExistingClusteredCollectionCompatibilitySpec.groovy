package io.micronaut.data.mongodb.index.validation.existingclusteredcompatibility
...
class MongoExistingClusteredCollectionCompatibilitySpec extends Specification implements MongoTestPropertyProvider {
    ...
    List<String> getPackageNames() {
        ['io.micronaut.data.mongodb.index.validation.existingclusteredcompatibility']
    }
