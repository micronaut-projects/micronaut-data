...
class DefaultMongoRepositoryOperationsSpec extends Specification {

    void "close does not shut down injected executor service"() {
        given:
            ExecutorService executorService = Executors.newSingleThreadExecutor()
            DefaultMongoRepositoryOperations operations = newOperations(executorService)
    ...
    private DefaultMongoRepositoryOperations newOperations(ExecutorService executorService) {
        ...
        beanContext.getBean(MongoConnectionOperations, _) >> Mock(MongoConnectionOperations)
        return new DefaultMongoRepositoryOperations(
                null,
                beanContext,
