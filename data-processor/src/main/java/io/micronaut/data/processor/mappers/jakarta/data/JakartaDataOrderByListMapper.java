...
public final class JakartaDataOrderByListMapper implements NamedAnnotationMapper {
    ...
    public String getName() {
        return "jakarta.data.repository.OrderBy.List";
    }

    @Override
    public List<AnnotationValue<?>> map(AnnotationValue<Annotation> annotation, VisitorContext visitorContext) {
        JakartaDataOrderByMapper jakartaDataOrderByMapper = new JakartaDataOrderByMapper();
        return List.of(
            AnnotationValue.builder(OrderBy.List.class).values(
