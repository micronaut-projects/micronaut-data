...
public final class JakartaDataSaveMapper implements NamedAnnotationMapper {
    ...
    public List<AnnotationValue<?>> map(AnnotationValue<Annotation> annotation, VisitorContext visitorContext) {
        return List.of(
            AnnotationValue.builder(Save.class).build(),
            AnnotationValue.builder(ConvertException.class)
                .values(new AnnotationClassValue<>("io.micronaut.data.runtime.support.exceptions.jakarta.data.JakartaDataInsertExceptionConverter"))
                .build()
        );
    }
}
