...
//
//        QueryBuilder2 encoder = new JpaQueryBuilder2()
//        String query = encoder.buildOrderBy("", entity, AnnotationMetadata.EMPTY_METADATA, sort, false, null)
//
//
//        expect:
...
//
//        QueryBuilder2 encoder = new JpaQueryBuilder2()
//            QueryBuilder2.InsertQueryDefinition definition = new SqlQueryBuilder2.SelectQueryDefinition(entity)
//        QueryResult encodedQuery = encoder.buildSelect(AnnotationMetadata.EMPTY_METADATA, q)
//
//
//        expect:
//        encodedQuery != null
