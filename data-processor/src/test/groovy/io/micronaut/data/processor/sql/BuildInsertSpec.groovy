...
""")
        ...
        Dialect.SQLITE     | 'CREATE TABLE "test" ("id" INTEGER PRIMARY KEY AUTOINCREMENT,"name" VARCHAR(255) NOT NULL);'
...
""")
        ...
        Dialect.SQLITE     | 'INSERT INTO "test" ("name") VALUES (?)'
...
""")
        ...
        Dialect.SQLITE     | 'CREATE TABLE "test" ("id" VARCHAR(36) PRIMARY KEY NOT NULL,"name" VARCHAR(255) NOT NULL);'
...
""")
        ...
        Dialect.H2         | 'INSERT INTO `test` (`name`) VALUES (?)'
        Dialect.POSTGRES   | 'INSERT INTO "test" ("name") VALUES (?)'
        Dialect.SQLITE     | 'INSERT INTO "test" ("name","id") VALUES (?,?)'
        Dialect.SQL_SERVER | 'INSERT INTO [test] ([name]) VALUES (?)'
    }
