...
""")
        ...
        Dialect.ANSI     | 'CREATE TABLE "test" ("id" INTEGER PRIMARY KEY AUTOINCREMENT,"name" VARCHAR(255) NOT NULL);'
...
""")
        ...
        Dialect.ANSI     | 'INSERT INTO "test" ("name") VALUES (?)'
        Dialect.SQL_SERVER | 'INSERT INTO [test] ([name]) VALUES (?)'
    }

    void "test build insert with only generated identity uses default values for ANSI"() {
        given:
        BeanDefinition beanDefinition = buildRepository('test.MyInterface', """
import io.micronaut.data.jdbc.annotation.JdbcRepository;
import io.micronaut.data.model.query.builder.sql.Dialect;
...
""")
        ...
        expect:
        getQuery(beanDefinition.findPossibleMethods("save").findFirst().get()) == 'INSERT INTO "test" DEFAULT VALUES'
    }
...
""")
        ...
        Dialect.ANSI     | 'CREATE TABLE "test" ("id" VARCHAR(36) PRIMARY KEY NOT NULL,"name" VARCHAR(255) NOT NULL);'
...
""")
        ...
        Dialect.H2         | 'INSERT INTO `test` (`name`) VALUES (?)'
        Dialect.POSTGRES   | 'INSERT INTO "test" ("name") VALUES (?)'
        Dialect.ANSI     | 'INSERT INTO "test" ("name","id") VALUES (?,?)'
        Dialect.SQL_SERVER | 'INSERT INTO [test] ([name]) VALUES (?)'
    }
...
""")
    ...
    @Unroll
    void "test build save returning for dialect - #dialect"() {
        given:
