...
""")
        ...
        where:
            ...
            query << [
                    ...
                    'SELECT user_."id",user_authorities_."id" AS authorities_id,user_authorities_."name" AS authorities_name,user_authorities_."user_id" AS authorities_user_id FROM "user" user_ INNER JOIN "authority" user_authorities_ ON user_."a_id"=user_authorities_."u_id" AND user_."x_id"=user_authorities_."y_id" WHERE (user_."id" = ?)',
            ]
    }
}
