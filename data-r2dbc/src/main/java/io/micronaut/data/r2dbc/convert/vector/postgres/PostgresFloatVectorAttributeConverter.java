...
/**
 * Attribute converter for Vector.FloatVector <-> io.r2dbc.postgresql.codec.Vector (pgvector).
 *
...
public final class PostgresFloatVectorAttributeConverter implements FloatVectorAttributeConverter<io.r2dbc.postgresql.codec.Vector> {

    @Override
    public @Nullable io.r2dbc.postgresql.codec.Vector convertToPersistedValue(@Nullable Vector.FloatVector entityValue, @NonNull ConversionContext context) {
        if (entityValue == null) {
            return null;
        }
    ...
    @Override
    public @Nullable Vector.FloatVector convertToEntityValue(@Nullable io.r2dbc.postgresql.codec.Vector persistedValue, @NonNull ConversionContext context) {
