...
@Internal
@Experimental
class OracleR2dbcJsonBinaryColumnReader implements SqlJsonColumnReader<Row> {

    private static final Logger LOG = LoggerFactory.getLogger(OracleR2dbcJsonBinaryColumnReader.class);
     ...
     *
     * @param binaryJsonMapper the oracle JSON object mapper
     */
    public OracleR2dbcJsonBinaryColumnReader(OracleJdbcJsonBinaryObjectMapper binaryJsonMapper) {
