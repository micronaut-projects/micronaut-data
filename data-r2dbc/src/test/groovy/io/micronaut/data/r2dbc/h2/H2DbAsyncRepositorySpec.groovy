...
class H2DbAsyncRepositorySpec extends AbstractAsyncRepositorySpec implements H2TestPropertyProvider {

    @Memoized
    @Override
    PersonAsyncRepository getPersonRepository() {
        return context.getBean(H2PersonAsyncRepository)
    }

    @Memoized
    @Override
    BookAsyncRepository getBookRepository() {
        return context.getBean(H2BookAsyncRepository)
    }
}
