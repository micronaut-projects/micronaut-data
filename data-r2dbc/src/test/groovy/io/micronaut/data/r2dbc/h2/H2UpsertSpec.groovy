...
import io.micronaut.data.r2dbc.h2.upsert.H2CustomerProfileRepository
import io.micronaut.data.r2dbc.h2.upsert.H2AutoPopulatedUpsertRepository
import io.micronaut.data.r2dbc.h2.upsert.H2CustomerProfileUuidRepository
import io.micronaut.data.r2dbc.h2.upsert.H2ProductReviewRepository
import io.micronaut.data.r2dbc.h2.upsert.H2WarehouseInventoryRepository
...
class H2UpsertSpec extends AbstractUpsertSpec implements H2TestPropertyProvider {
    ...
    CustomerProfileUuidRepository getCustomerProfileUuidRepository() {
        return context.getBean(H2CustomerProfileUuidRepository)
    }
