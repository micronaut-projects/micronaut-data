...
class MariaDbReactiveRepositorySpec extends AbstractReactiveRepositorySpec implements MariaDbTestPropertyProvider {

    @Memoized
    @Override
    PersonReactiveRepository getPersonRepository() {
        return context.getBean(MySqlPersonReactiveRepository)
    }
