...
import io.micronaut.data.r2dbc.mysql.MySqlUuidRepository
import io.micronaut.data.r2dbc.mysql.MySqlUuidNullRepository
...
class MariaUUIDSpec extends AbstractUUIDSpec implements MariaDbTestPropertyProvider {
