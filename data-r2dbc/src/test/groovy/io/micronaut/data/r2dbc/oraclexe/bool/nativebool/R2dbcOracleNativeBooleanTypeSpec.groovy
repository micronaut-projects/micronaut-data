...
class R2dbcOracleNativeBooleanTypeSpec extends Specification implements OracleXETestPropertyProvider {
    ...
    void "test oracle native boolean type is selected by TypeDef for r2dbc"() {
        given:
