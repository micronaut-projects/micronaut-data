...
public class SalePgJsonItem {
  ...
  public SalePgJsonItem(Long id, SalePgJsonb sale, String name, @Nullable Map<String, String> data) {
      this.id = id;
      this.sale = sale;
      this.name = name;
      this.data = data;
    ...
    public SalePgJsonb getSale() {
        return sale;
    }

    public void setSale(SalePgJsonb sale) {
        this.sale = sale;
    }
