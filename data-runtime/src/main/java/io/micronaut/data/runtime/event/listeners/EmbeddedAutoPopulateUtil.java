...
/**
 * Internal utilities for recursive embedded population.
 *
 * This helper centralizes the traversal of embedded associations and applies a provided
 ...
 */
@Internal
final class EmbeddedAutoPopulateUtil {

    private EmbeddedAutoPopulateUtil() {
    }
    ...
    public static Object populateEmbedded(RuntimePersistentEntity<?> embeddedEntity,
                                          Object instance,
