...
/**
 * Default implementation of {@link DeleteReturningOneInterceptor}.
 ...
 */
@Internal
public final class DefaultDeleteReturningOneInterceptor<T, R> extends AbstractQueryInterceptor<T, R> implements DeleteReturningOneInterceptor<T, R> {

    /**
     * Default constructor.
     * @param datastore The operations
     */
    public DefaultDeleteReturningOneInterceptor(@NonNull RepositoryOperations datastore) {
        super(datastore);
    }
