 ...
 */
@Internal
public final class DefaultInsertReturningManyInterceptor<T, R> extends AbstractQueryInterceptor<T, Iterable<R>> implements InsertReturningManyInterceptor<T, R> {

    /**
     * Default constructor.
     * @param datastore The operations
     */
    public DefaultInsertReturningManyInterceptor(@NonNull RepositoryOperations datastore) {
        super(datastore);
    }
