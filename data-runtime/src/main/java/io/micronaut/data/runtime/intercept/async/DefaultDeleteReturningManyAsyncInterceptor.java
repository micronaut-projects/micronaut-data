...
/**
 * The default implementation of {@link DeleteReturningManyAsyncInterceptor}.
 *
 ...
 */
@Internal
public final class DefaultDeleteReturningManyAsyncInterceptor<T, R> extends AbstractAsyncInterceptor2<T, Iterable<R>> implements DeleteReturningManyAsyncInterceptor<T, R> {
     ...
     */
    DefaultDeleteReturningManyAsyncInterceptor(RepositoryOperations datastore) {
        super(datastore);
    }
