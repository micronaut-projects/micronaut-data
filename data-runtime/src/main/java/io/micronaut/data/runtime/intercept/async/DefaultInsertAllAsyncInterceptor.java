...
/**
 * Default implementation of {@link InsertAllAsyncInterceptor}.
 *
 * @since 5.0.0
 */
public class DefaultInsertAllAsyncInterceptor extends AbstractCountConvertCompletionStageInterceptor implements InsertAllAsyncInterceptor<Object> {
     ...
     */
    protected DefaultInsertAllAsyncInterceptor(@NonNull RepositoryOperations datastore) {
        super(datastore);
    }
