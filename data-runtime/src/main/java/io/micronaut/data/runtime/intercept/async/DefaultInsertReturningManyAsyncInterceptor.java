...
/**
 * The default implementation of {@link InsertReturningManyAsyncInterceptor}.
 *
 ...
 */
@Internal
public final class DefaultInsertReturningManyAsyncInterceptor<T, R> extends AbstractAsyncInterceptor2<T, Iterable<R>> implements InsertReturningManyAsyncInterceptor<T, R> {
     ...
     */
    DefaultInsertReturningManyAsyncInterceptor(RepositoryOperations datastore) {
        super(datastore);
    }
