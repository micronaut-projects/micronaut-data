...
/**
 * The default implementation of {@link InsertReturningOneAsyncInterceptor}.
 *
 ...
 */
@Internal
public final class DefaultInsertReturningOneAsyncInterceptor<T, R> extends AbstractAsyncInterceptor<T, R> implements InsertReturningOneAsyncInterceptor<T, R> {
     ...
     */
    DefaultInsertReturningOneAsyncInterceptor(RepositoryOperations datastore) {
        super(datastore);
    }
