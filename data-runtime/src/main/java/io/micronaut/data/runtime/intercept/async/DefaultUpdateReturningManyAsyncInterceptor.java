...
/**
 * The default implementation of {@link UpdateReturningManyAsyncInterceptor}.
 *
 ...
 */
@Internal
public final class DefaultUpdateReturningManyAsyncInterceptor<T, R> extends AbstractAsyncInterceptor2<T, Iterable<R>> implements UpdateReturningManyAsyncInterceptor<T, R> {
     ...
     */
    DefaultUpdateReturningManyAsyncInterceptor(RepositoryOperations datastore) {
        super(datastore);
    }
