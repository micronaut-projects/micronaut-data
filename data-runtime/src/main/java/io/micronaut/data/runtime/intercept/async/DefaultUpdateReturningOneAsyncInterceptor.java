...
/**
 * Default asynchronous interceptor for update-returning repository methods.
 *
 * @author radovanradic
 * @since 5.0.5
 */
@Internal
public class DefaultUpdateReturningOneAsyncInterceptor extends AbstractConvertCompletionStageInterceptor<Object>
    implements UpdateReturningOneAsyncInterceptor<Object, Object> {

    protected DefaultUpdateReturningOneAsyncInterceptor(RepositoryOperations datastore) {
        super(datastore);
    }
