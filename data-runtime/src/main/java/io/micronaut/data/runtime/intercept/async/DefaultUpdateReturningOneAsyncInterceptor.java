...
/**
 * The default implementation of {@link UpdateReturningOneAsyncInterceptor}.
 *
 ...
 */
@Internal
public final class DefaultUpdateReturningOneAsyncInterceptor<T, R> extends AbstractAsyncInterceptor<T, R> implements UpdateReturningOneAsyncInterceptor<T, R> {
     ...
     */
    DefaultUpdateReturningOneAsyncInterceptor(RepositoryOperations datastore) {
        super(datastore);
    }
