...
abstract class AbstractAsyncRepositorySpec extends Specification {
    ...
    abstract BookAsyncRepository getBookRepository()
    ...
    void "test criteria pagination"() {
        ...
        when:
            Page<Book> page = bookRepository.findAll(criteria, Pageable.from(0, 10, Sort.of(Sort.Order.asc("title")))).get()
        ...
        when:
            ...
            page = bookRepository.findAll(criteria, pageable).get()
