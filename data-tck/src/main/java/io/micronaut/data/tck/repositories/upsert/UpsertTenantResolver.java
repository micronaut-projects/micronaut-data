...
/**
 * Fixed tenant resolver used by upsert TCK specifications.
 */
@Singleton
@Requires(property = "test.upsert.tenant.enabled")
final class UpsertTenantResolver implements TenantResolver {
