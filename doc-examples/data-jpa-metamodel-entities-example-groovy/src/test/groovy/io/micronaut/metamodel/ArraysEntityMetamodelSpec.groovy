    ...
    ExpectedMetamodel getExpectedMetamodel() {
        return new ExpectedMetamodel(
                ...
                List.of(
                        ...
                        new Attribute("stringArrayCollection", SingularAttribute, [Collection, String], ARRAYS_ENTITY_CLASS_NAME),
                        ...
                        new Attribute("shortArrayCollection", SingularAttribute, [Collection, Short], ARRAYS_ENTITY_CLASS_NAME),
                        ...
                        new Attribute("integerArrayCollection", SingularAttribute, [Collection, Integer], ARRAYS_ENTITY_CLASS_NAME),
                        ...
                        new Attribute("longArrayCollection", SingularAttribute, [Collection, Long], ARRAYS_ENTITY_CLASS_NAME),
                        ...
                        new Attribute("floatArrayCollection", SingularAttribute, [Collection, Float], ARRAYS_ENTITY_CLASS_NAME),
                        ...
                        new Attribute("doubleArrayCollection", SingularAttribute, [Collection, Double], ARRAYS_ENTITY_CLASS_NAME),
                        ...
                        new Attribute("characterArrayCollection", SingularAttribute, [Collection, Character], ARRAYS_ENTITY_CLASS_NAME),
                        ...
                        new Attribute("booleanArrayCollection", SingularAttribute, [Collection, Boolean], ARRAYS_ENTITY_CLASS_NAME),
                ),
                List.of()
        )
    }
