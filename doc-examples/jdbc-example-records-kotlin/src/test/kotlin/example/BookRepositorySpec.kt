...
class BookRepositorySpec {
    ...
    fun testCrud() {
        ...
        // tag::save[]
        var book = Book(0, null, "The Stand", 1000)
    ...
    fun testPageable() {
        ...
        bookRepository.saveAll(Arrays.asList(
                Book(0, null,"The Stand", 1000),
                Book(0, null,"The Shining", 600),
                Book(0, null,"The Power of the Dog", 500),
                Book(0, null,"The Border", 700),
                Book(0, null,"Along Came a Spider", 300),
                Book(0, null,"Pet Cemetery", 400),
                Book(0, null,"A Game of Thrones", 900),
                Book(0, null,"A Clash of Kings", 1100)
        ))
        // end::saveall[]
    ...
    @Test
    fun testDto() {
        bookRepository.save(Book(0, null, "The Shining", 400))
