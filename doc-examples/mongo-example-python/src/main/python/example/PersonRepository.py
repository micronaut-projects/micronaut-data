...
from micronaut.data.model.jpa.criteria import PersistentEntityCriteriaBuilder
...
class PersonRepository(CrudRepository[Person, ObjectId]):
    ...
    def findByInterestsCollectionContains(self, interest: str) -> list[Person]: ...
...
def interests_contains(interest: str):
    return lambda root, criteria_builder: criteria_builder.arrayContains(root.get("interests"), criteria_builder.literal(interest))
