...
class BookDatabaseMultiTenancySpec {
    ...
    void testRest() {
        ...
        assertEquals(1, mongoClient.getDatabase("foo").getCollection("book").countDocuments());
        assertEquals(0, mongoClient.getDatabase("bar").getCollection("book").countDocuments());
