...
Specific criteria supported only by Azure Cosmos is `ARRAY_CONTAINS` and for a class having an array of strings named `tags` it can be used either via custom repository method like this:
