...
=== `@JsonView` annotation has a new required field `entity`

When using the `@JsonView` annotation, users have to provide the entity class this view represents, here is an example usage:
