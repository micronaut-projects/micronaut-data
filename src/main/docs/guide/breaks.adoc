...
Alternatively, projects can opt into the previous embedded naming behavior at compilation time by setting the annotation processor option `micronaut.data.embedded.naming-strategy=LEGACY`. The default value is `STANDARD`.
