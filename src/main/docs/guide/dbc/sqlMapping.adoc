As mentioned in the <<dbcQuickStart, Quick Start>> section, if you need to customize how entities map to the table and column names of the database you can use JPA annotations to do so or Micronaut Data's own annotations in the `io.micronaut.data.annotation` package.
