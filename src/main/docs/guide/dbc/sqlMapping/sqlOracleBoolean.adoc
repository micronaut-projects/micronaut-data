...
It is not runtime database version detection, it does not inspect JDBC or R2DBC connection metadata, and it is not a general datasource capability check.
