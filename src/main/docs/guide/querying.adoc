The implementation of querying in Predator is based on the dynamic finders in https://gorm.grails.org[GORM].
...
snippet::example.BookRepository[project-base="examples/example", source="main", tags="simple", indent="0"]
...
snippet::example.BookRepository[project-base="examples/example", source="main", tags="simple-alt", indent="0"]
