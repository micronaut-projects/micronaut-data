...
snippet::example.BookRepository[project-base="examples/example", source="main", tags="simple-projection", indent="0"]
...
snippet::example.BookRepository[project-base="examples/example", source="main", tags="top-projection", indent="0"]
