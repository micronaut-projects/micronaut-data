...
NOTE: Some operations (for example update methods that return updated data) require the backing implementation to support executing a prepared query and mapping a returned result. Support for such operations can vary by backend.
