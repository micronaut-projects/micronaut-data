...
For Oracle JDBC transactions, Micronaut Data supports ambiguous commit recovery with ann:transaction.annotation.TransactionalRecoverable[].
See <<recoverableTransactions, Oracle Transaction Recovery>> for configuration, scope, and usage details.
