...
class SQLiteAsyncRepositorySpec extends AbstractAsyncRepositorySpec implements SQLiteTestPropertyProvider {

    @Memoized
    @Override
    PersonAsyncRepository getPersonRepository() {
        return context.getBean(SQLiteAsyncPersonRepository)
    }

    @Memoized
    @Override
    BookAsyncRepository getBookRepository() {
        return context.getBean(SQLiteAsyncBookRepository)
    }
}
