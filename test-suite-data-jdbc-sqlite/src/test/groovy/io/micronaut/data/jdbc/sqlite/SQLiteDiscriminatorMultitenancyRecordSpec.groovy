...
class SQLiteDiscriminatorMultitenancyRecordSpec extends Specification implements SQLiteTestPropertyProvider {

    Map<String, String> getExtraProperties() {
        return [accountRepositoryClass: SQLiteAccountRecordRepository.name]
    }
