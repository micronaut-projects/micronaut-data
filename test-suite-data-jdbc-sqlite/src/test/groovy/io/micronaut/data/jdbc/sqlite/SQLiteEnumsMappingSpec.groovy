...
class SQLiteEnumsMappingSpec extends Specification implements SQLiteTestPropertyProvider {
    @AutoCleanup
    @Shared
    ...
    void "test create table with enums"() {
        ...
        then:
            sql == 'CREATE TABLE "enum_entity" ("id" INTEGER PRIMARY KEY,"as_default" VARCHAR(255) NOT NULL,"as_string" VARCHAR(255) NOT NULL,"as_int" INT NOT NULL);'
    }
    ...
    void "test jpa create table with enums"() {
        ...
        then:
            sql == 'CREATE TABLE "jpa_enum_entity" ("id" INTEGER PRIMARY KEY,"as_default" INT NOT NULL,"as_string" VARCHAR(255) NOT NULL,"as_int" INT NOT NULL);'
    }
