...
import static io.micronaut.data.jdbc.sqlite.jakarta_data.persistence.CatalogProduct.Department.GROCERY;
...
//        assertEquals(794.09, catalog.sumPrices(Department.CLOTHING, Department.APPLIANCES), 0.001);
    ...
    public void testIdAttributeWithDifferentName() {
        ...
        catalog.customSave(CatalogProduct.of("apple", 1.19, "TEST-PROD-12", GROCERY));
        catalog.customSave(CatalogProduct.of("pear", 0.99, "TEST-PROD-14", GROCERY));
        catalog.customSave(CatalogProduct.of("orange", 1.09, "TEST-PROD-16", GROCERY));
        catalog.customSave(CatalogProduct.of("banana", 0.49, "TEST-PROD-17", GROCERY));
        catalog.customSave(CatalogProduct.of("plum", 0.89, "TEST-PROD-18", GROCERY));
    ...
    public void testInsertEntityThatAlreadyExists() {
        ...
        CatalogProduct prod1 = catalog.add(CatalogProduct.of("watermelon", 6.29, "TEST-PROD-94", GROCERY));
    ...
    public void testMultipleInsertUpdateDelete() {
        ...
        CatalogProduct[] added = catalog.addMultiple(CatalogProduct.of("blueberries", 2.49, "TEST-PROD-95", GROCERY),
            CatalogProduct.of("strawberries", 2.29, "TEST-PROD-96", GROCERY),
            CatalogProduct.of("raspberries", 2.39, "TEST-PROD-97", GROCERY));
...
//        assertEquals(Set.of(GROCERY), added[0].getDepartments());
...
//        assertEquals(Set.of(GROCERY), added[1].getDepartments());
...
//        assertEquals(Set.of(GROCERY), added[2].getDepartments());
...
//        assertEquals(Set.of(GROCERY), modified[0].getDepartments());
...
//        assertEquals(Set.of(GROCERY), modified[1].getDepartments());
        strawberries = modified[1];

        // Attempt to remove entities that do not exist in the database
        try {
            catalog.removeMultiple(CatalogProduct.of("blackberries", 2.59, "TEST-PROD-98", GROCERY),
                CatalogProduct.of("gooseberries", 2.79, "TEST-PROD-99", GROCERY));
    ...
    public void testNull() {
        ...
        catalog.customSave(CatalogProduct.of("spinach", 2.28, "TEST-PROD-51", GROCERY));
        catalog.customSave(CatalogProduct.of("broccoli", 2.49, "TEST-PROD-52", GROCERY));
        catalog.customSave(CatalogProduct.of("rhubarb", null, "TEST-PROD-53", GROCERY));
        catalog.customSave(CatalogProduct.of("potato", 0.79, "TEST-PROD-54", GROCERY));
    ...
    public void testSort() {
        ...
        catalog.customSave(CatalogProduct.of("toothpaste", 2.39, "TEST-PROD-72", CatalogProduct.Department.PHARMACY, GROCERY));
    ...
    public void testVersionedInsertUpdateDelete() {
        ...
        CatalogProduct prod1 = catalog.add(CatalogProduct.of("zucchini", 1.49, "TEST-PROD-91", GROCERY));
        CatalogProduct prod2 = catalog.add(CatalogProduct.of("cucumber", 1.29, "TEST-PROD-92", GROCERY));
